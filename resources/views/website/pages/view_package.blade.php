...
@include('website.components.deal_seo', ['deal' => $package])

@section('pages')
@include('website.components.deal_gallery', ['deal' => $package])
        ...
        <div class="col-lg-8 pb-5">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('website.components.deal_video', ['deal' => $package])
                    <hr>

                    @include('website.components.deal_map', ['deal' => $package, 'title' => 'Tour Location On Map'])

                </div>
            </div>
            <hr>

            @include('website.components.deal_reviews', ['deal' => $package, 'paginatedReviews' => $paginatedReviews ?? collect(), 'reviewTitle' => 'Reviews for this Tour'])
        </div>
                                    ...
                                    <div class="text-end">
                                        <p class="mb-0" style="font-size: 1.5rem; font-weight: 700; color: #ff5722;">
                                            ...
                                            <span id="package_total_price_display"
                                                ...
                                                data-currency="{{ e($packagePriceData['currency']) }}"
                                                data-decimals="2">
                                                {{ $packagePriceData['formatted'] }}
                                            </span>
                                        </p>
                                    </div>
                                </div>

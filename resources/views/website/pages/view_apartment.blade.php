...
<section class="gallery">
    <div class="gmz-carousel-with-lightbox" data-count="{{ $apartment->photos->count() }}">
        ...
        <a href="{{ asset('storage/' . $photo->photo) }}">
            <img src="{{ asset('storage/' . $photo->photo) }}" alt="{{ $apartment->title }}" class="gallery-img"
        ...
        <a
            ...
            <img src="{{ $apartment->cover_photo ? asset('storage/' . $apartment->cover_photo) : 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop&crop=center' }}"
                alt="{{ $apartment->title }}" class="gallery-img"
                style="width: 100%; height: 400px; object-fit: cover; display: block; opacity: 0; transition: opacity 0.5s;"
                loading="lazy" />
        </a>
        @endforelse
            ...
            <div class="card">
                <div class="card-body">
                    <div class="hotel-star">
                        @include('website.components.star_rating', ['rating' => $apartment->star_rating ?? 5])
                    </div>
                    ...
                    <section class="description">
                        ...
                        <div class="section-content">
                            <p>
                                {!! $apartment->policies ?? '<strong>Check-in/Check-out:</strong> Check-in: 2:00 PM,
                                Check-out:
                                11:00 AM<br><br><strong>Cancellation Policy:</strong> Free cancellation up to 48 hours
                                before
                                arrival. Late cancellations may incur charges.<br><br><strong>House Rules:</strong> No
                                smoking
                                inside the apartment, No pets allowed, Quiet hours from 10 PM to 7 AM, Maximum occupancy
                                as
                                specified.' !!}
                            </p>
                        </div>
                    ...
                    <section class="map">
                        ...
                        <div id="address-map-container" style="width: 100%; height: 400px">
                            ...
                            @else
                            <iframe width="100%" height="100%" frameborder="0" style="border:0; border-radius: 8px;"
                                src="https://www.google.com/maps?q={{ $apartment->location }}&output=embed"
                                allowfullscreen aria-hidden="false" tabindex="0" loading="lazy"
                                referrerpolicy="no-referrer-when-downgrade"></iframe>
                            @endif
                        </div>
                        ...
                        <div class="popup-inner">
                            ...
                            <div class="popup-content">
                                <div class="comment-form-wrapper">
                                    <form action="{{ route('deals.reviews.store', $apartment->id) }}"
            ...
            <div class="siderbar-single">
                ...
                <div class="card mb-4 booking-card rounded"
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('book-deal') }}" method="POST" class="apartment-booking-form" data-require-login="1">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="check_in" name="check_in" required
                                        min="{{ date('Y-m-d') }}" onchange="calculateApartmentPrice()">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="check_out" class="form-label">Check-out Date</label>
                                    <input type="date" class="form-control" id="check_out" name="check_out" required
                                        min="{{ date('Y-m-d', strtotime('+1 day')) }}"
                                        onchange="calculateApartmentPrice()">
                                </div>
                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="mb-1" style="font-size: 0.9rem; color: #666;">
                                            <span id="apartment_nights">1</span> night(s) ×
                                            ${{ number_format($apartment->base_price ?? 0, 2) }}/night
                                        </p>
                                    </div>
                                    <div class="text-end">
                                        <p class="mb-0" style="font-size: 1.5rem; font-weight: 700; color: #ff5722;">
                                            $<span id="apartment_total_price">{{ number_format($apartment->base_price ?? 0,
                                                2) }}</span>
                                        </p>
                                    </div>
                                </div>
                ...
                <script>
                    function calculateApartmentPrice() {
                        ...
                        const pricePerNight = {{ $apartment->base_price ?? 0 }};
                        let nights = 1;
                        if (checkIn && checkOut) {
                        ...
                        document.getElementById('apartment_nights').textContent = nights;
                        document.getElementById('apartment_total_price').textContent = totalPrice.toFixed(2);
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        document.getElementById('check_in').addEventListener('change', calculateApartmentPrice);
                        document.getElementById('check_out').addEventListener('change', calculateApartmentPrice);
                    });
                </script>
                ...
                <div class="tour-item tour-item--grid" data-plugin="matchHeight">
                    ...
                    <div class="tour-item__details" style="padding-top:18px;">
                        <div class="star-rating mb-2">
                            @include('website.components.star_rating', ['rating' => $apartment->star_rating ?? 5, 'size' => 'small'])
                        </div>
